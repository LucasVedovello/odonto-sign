  ...
  public: {
    Tables: {
      ...
      terms: {
        ...
        Relationships: [
          {
            foreignKeyName: "terms_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "terms_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "patients"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      public_complete_patient_registration: {
        Args: { p_data: Json; p_token: string }
        Returns: Json
      }
      public_get_patient_registration: {
        Args: { p_token: string }
        Returns: Json
      }
      public_get_signed_document: {
